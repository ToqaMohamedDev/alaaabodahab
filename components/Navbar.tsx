...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-lg dark:shadow-gray-900/50 fixed top-0 left-0 right-0 z-50 border-b border-gray-200/50 dark:border-gray-700/50"
    >
      {/* Progress Bar */}
